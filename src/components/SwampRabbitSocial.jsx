  ...
  return (
    <div className={style}>
      ...
      <P center>
        ...
        on time after a group photo. Mileage will range from 5-20 miles 
        depending on participants' interests. We will meet back at the start 
        afterwards for lunch and some spicy conversation.
        HELMETS REQUIRED.
      </P>
    </div>
  )
